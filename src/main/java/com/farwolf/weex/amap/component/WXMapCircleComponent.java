package com.farwolf.weex.amap.component;
...
@WeexComponent(name = "weex-amap-circle")
public class WXMapCircleComponent extends AbstractMapWidgetComponent<Circle> {
  ...
  protected View initComponentHostView(@NonNull Context context) {
    if (getParent() != null && getParent() instanceof com.farwolf.weex.amap.component.WXMapViewComponent) {
      initCircle();
    }
  ...
  private void initCircle() {
    postMapOperationTask((com.farwolf.weex.amap.component.WXMapViewComponent) getParent(), new com.farwolf.weex.amap.component.WXMapViewComponent.MapOperationTask() {
      @Override
